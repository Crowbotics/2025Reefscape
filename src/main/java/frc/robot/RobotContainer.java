...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    NamedCommands.registerCommand("moveArmStateUp", m_arm.moveArmStateUp());
    NamedCommands.registerCommand("moveArmStateDown", m_arm.moveArmStateDown());
  ...
  private void configureButtonBindings() 
  {
    ...
    //Arm Buttons
    new Trigger(driverRightBumper.onTrue(m_arm.moveArmStateUp()));
    new Trigger(driverLeftBumper.onTrue(m_arm.moveArmStateDown()));

    //Climber Buttons
    new Trigger(driverSelect.onTrue(
      new SequentialCommandGroup(
        m_arm.moveArmStateToBeginClimbCommand(),
        m_arm.moveArmCommand().until(m_arm::isArmAtSetpoint),
        m_climber.releaseWinch())));

    new Trigger(driverStart.onTrue(
      new SequentialCommandGroup(
        m_arm.moveArmStateToEndClimbCommand(),
        m_arm.moveArmCommand().until(m_arm::isArmAtSetpoint), 
        m_climber.retractWinch())));
